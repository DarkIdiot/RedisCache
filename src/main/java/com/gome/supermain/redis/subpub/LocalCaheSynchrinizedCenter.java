package com.gome.supermain.redis.subpub;

import static com.gome.supermain.redis.common.Method.clear;
import static com.gome.supermain.redis.common.Method.put;
import static com.gome.supermain.redis.common.Method.remove;
import static com.gome.supermain.redis.common.Method.valueOf;
...
import com.gome.supermain.redis.LocalMap;
import com.gome.supermain.redis.common.Method;
import com.gome.supermain.redis.config.IPorServerConfig;
...
public class LocalCaheSynchrinizedCenter {
	...
	public static void consume(String message){
		...
		if( localCache != null ){
			if(put.equals(valueOf(method)) || remove.equals(valueOf(method)) ){
				localCache.remove(keyObject.toString());
				log.info("RedisMap consume " + name + ".remove(" + key + ") " + message);
			}else if( clear.equals(valueOf(method)) ){
				localCache.clear();
